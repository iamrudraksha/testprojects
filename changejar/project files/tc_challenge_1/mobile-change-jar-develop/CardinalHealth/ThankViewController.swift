...
class ThankViewController: UIViewController, UIActionSheetDelegate {
    ...
    override func viewDidLoad() {
        ...
        let titleFont = UIFont(name: Fonts.light, size: titleFontSize)!
    ...
    */
    ...
    - parameter actionSheet: the actionSheet
    - parameter buttonIndex: the index of the tapped button
    */
    ...
    */
    func getAttributedString() -> NSAttributedString {
        ...
        for item in json.arrayValue {
            ...
            str += title + text
            titleRanges.append(NSMakeRange(lastLen, title.characters.count))
            lastLen += title.characters.count
            textRanges.append(NSMakeRange(lastLen, text.characters.count))
            lastLen += text.characters.count
