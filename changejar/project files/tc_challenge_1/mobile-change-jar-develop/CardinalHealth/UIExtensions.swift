...
*
* changes:
* - KeyboardDismissingUIView is removed
*/
...
extension UIViewController {
    ...
    */
    ...
    - parameter buttons: the data for the buttons (icon and selector)
    */
...
extension UIImage {
    ...
    - parameter callback: the callback to return the image or nil
    */
...
extension UIViewController {
    ...
    */
    ...
    - parameter viewController: the view controller to show from bottom
    */
